...
public class Student {
    ...
    public void calcAvarage() {
        this.avarage = (((this.mat.note*0.75)+(this.mat.verbalNote*0.25))+((this.fizik.note * 0.80) + (this.fizik.verbalNote * 0.20)) + ((this.kimya.note * 0.70) + (this.kimya.verbalNote * 0.30))) / 3.0;
    }
